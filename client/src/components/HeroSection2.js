    ...
    return (
        <div>
            ...
            <div style={{ height: "900px", backgroundColor: "lightgrey", marginTop: "-35px" }}>
                ...
                <div>
                    <img style={{ height: "150px", width: "150px", borderRadius: "50%", marginLeft: "1100px", marginTop: "-720px" }} src="images/user-1.jpg" /> <p style={{ fontSize: "18px", color: "green", fontWeight: "600", marginTop: "-380px", marginLeft: "1270px" }}>- Catherine</p>
                </div>
                <div style={{ width: "500px", marginLeft: "950px", marginTop: "-250px", fontSize: "14.5px", fontFamily: "sans-serif", color: "grey", textAlign: "center" }}>
